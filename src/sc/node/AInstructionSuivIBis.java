...
public final class AInstructionSuivIBis extends PIBis
{
    private PI _i_;
    private PIBis _iBis_;

    public AInstructionSuivIBis()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInstructionSuivIBis(
            cloneNode(this._i_),
    ...
    {
        ((Analysis) sw).caseAInstructionSuivIBis(this);
    }
