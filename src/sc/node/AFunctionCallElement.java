...
public final class AFunctionCallElement extends PElement
{
    private PAppFunction _appFunction_;

    public AFunctionCallElement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionCallElement(
    ...
    {
        ((Analysis) sw).caseAFunctionCallElement(this);
    }
